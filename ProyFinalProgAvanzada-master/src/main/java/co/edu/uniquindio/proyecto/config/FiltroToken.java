        ...
        if (request.getMethod().equals("OPTIONS")) {
            ...
            try {
                ...
                if (requestURI.startsWith("/api/cliente")) {
                    error = validarToken(token, TipoUsuario.CLIENT);
                }else {
                    error = false;
                }
                ...
                //Si la petición es para la ruta /api/admin se verifica que el token exista y que el rol sea CLIENTE
                if (requestURI.startsWith("/api/admin")) {
                    error = validarToken(token, TipoUsuario.ADMIN);
                }else {
                    error = false;
                }
